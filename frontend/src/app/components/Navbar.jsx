...
<nav
  className={`${
    !isComparePage ? "fixed top-0 left-0 right-0" : ""
...
>
  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div className="flex items-center justify-between h-16 md:h-20">
      {/* Logo - Enhanced with better visual hierarchy */}
      <a 
        href="/" 
        className="flex items-center gap-3 group transition-all duration-300 hover:scale-[1.02] active:scale-[0.98]"
      >
        <div className="relative bg-gradient-to-br from-blue-600 to-indigo-700 p-2 rounded-xl shadow-md group-hover:shadow-lg transition-all duration-300">
  ...
  {isMobileMenuOpen && (
    ...
    >
      ...
      {/* Spacer */}
    {!isComparePage && <div className="h-16" />}
    </>
  );
};
